...
exports.config = {
  name: 'pinterest',
  author: '@jm',
  description: 'Searches Pinterest for pins based on a keyword',
  method: 'get',
  category: 'search',
  link: ['/pinterest?search=brp port&count=10']
};
...
exports.initialize = function ({ req, res }) {
  ...
  if (!searchTitle) {
    return res.json({ error: "Missing 'search' and 'count' parameters." });
  }
