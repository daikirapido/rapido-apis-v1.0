...
const createLogger = (colorFn, prefix = '') => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Mark ]${prefix} » ${text}`)));
...
const createErrorLogger = (colorFn) => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Mark ] [ Error ] » ${text}`)));

// Create warn logger with [ Warn ] prefix
const createWarnLogger = (colorFn) => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Mark ] [ Warn ] » ${text}`)));
